...
function Get-RepositoriesInfo {
  ...
  $reposOrder = @("ArtiWave", "Cours", "DailyPush", "DataScrub", "Documentations", "Dotfiles", "EmmanuelLefevre", "GitHubProfileIcons", "GoogleSheets", "IAmEmmanuelLefevre", "MarkdownImg", "PolarsFlow", "ReplicaMySQL", "Schemas", "ScrapMate", "Soutenances")
  ...
  $repos = @{
    ...
    "PolarsFlow"              = "$env:USERPROFILE\Desktop\Projets\PolarsFlow"
